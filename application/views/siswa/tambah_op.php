                ...
                <div class="card-body">
                    <form action="" method="post">
                        <div class="">
                            ...
                            <input maxlength="10" type="text" name="nis" class="form-control" id="nis" placeholder="Masukkan NIS anda">
                        ...
                        <a href="<?= base_url('vote/siswaOp'); ?>" class="btn btn-primary float-right">Batal</a>
                    </form>
                </div>
            </div>
