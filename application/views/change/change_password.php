            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="" method="post">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary float-right ml-4">Simpan</button>

                        <?php if ($level == "admin") : ?>
                            <a href="<?= base_url('vote/admin') ?>" type="submit" name="batal" class="btn btn-primary float-right">Batal</a>
                        <?php elseif ($level == "operator") : ?>
                            <a href="<?= base_url('vote/operator') ?>" type="submit" name="batal" class="btn btn-primary float-right">Batal</a>
                        <?php else : ?>
